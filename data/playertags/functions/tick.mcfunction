...
execute as @a if score enabled pt_options_admin matches 1 unless entity @s[team=pt_zz] at @s unless entity @e[type=minecraft:text_display,tag=afk_detector,distance=0..0.0001] run execute as @s run function playertags:transfer/to_active
...
execute as @a at @s if score enabled pt_options_admin matches 1 if score @s pt_options matches 0.. unless entity @s[team=pt_zz] if score @s pt_afk = @s pt_options if entity @e[type=minecraft:text_display,tag=afk_detector,distance=0..0.0001] run function playertags:transfer/to_afk
...
execute as @a at @s if score enabled pt_options_admin matches 1 unless score @s pt_options matches 0.. unless entity @s[team=pt_zz] if score @s pt_afk = timer pt_options_admin if entity @e[type=minecraft:text_display,tag=afk_detector,distance=0..0.0001] run function playertags:transfer/to_afk
...
execute as @a at @s if entity @s[nbt={SelectedItem:{id:"minecraft:written_book",tag:{pages:[],title:"Player Tags"}}}] run function playertags:transfer/book

# Update players from book
execute as @e[type=minecraft:item_frame,nbt={Item:{tag:{player_tags:{custom:1b}}}}] at @s run function playertags:transfer/to_team
execute as @e[type=minecraft:glow_item_frame,nbt={Item:{tag:{player_tags:{custom:1b}}}}] at @s run function playertags:transfer/to_team
